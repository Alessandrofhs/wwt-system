                        ...
                        <div class="browser-visits">
                            <ul>
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                        <img src="{{ asset('deskapp-master/vendors/images/chrome.png') }}"
                                            alt="" />
                                    </div>
                                ...
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                        <img src="{{ asset('deskapp-master/vendors/images/firefox.png') }}"
                                            alt="" />
                                    </div>
                                ...
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                        <img src="{{ asset('deskapp-master/vendors/images/safari.png') }}"
                                            alt="" />
                                    </div>
                                ...
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                        <img src="{{ asset('deskapp-master/vendors/images/edge.png') }}"
                                            alt="" />
                                    </div>
                                ...
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                        <img src="{{ asset('deskapp-master/vendors/images/opera.png') }}"
                                            alt="" />
                                    </div>
